...
public class CombustionEngineBlock extends EngineBlock {
	public CombustionEngineBlock(Settings settings) {
	...
	public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
		return validateTicker(type, ModMachines.COMBUSTION_ENGINE_BLOCK_ENTITY, CombustionEngineBlockEntity::tick);
	}

	@Override
	protected MapCodec<? extends BlockWithEntity> getCodec() {
		return createCodec(CombustionEngineBlock::new);
	}
}
